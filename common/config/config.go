...
func (this *dad-goConfig) GetBookkeepers() ([]keypair.PublicKey, error) {
...
func (this *dad-goConfig) GetDefaultNetworkId() (uint32, error) {
...
func (this *dad-goConfig) getDefNetworkIDFromGenesisConfig(genCfg *GenesisConfig) (uint32, error) {
	var configData []byte
	var err error
	switch this.Genesis.ConsensusType {
	case CONSENSUS_TYPE_VBFT:
