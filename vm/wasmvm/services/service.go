...
func (i *InterOpService) Invoke(methodad-gome string, params []uint64, mem *memory.VMmemory) (uint64, error) {

	if v, ok := i.serviceMap[methodad-gome]; ok {
		return v(mem, params)
	}
	return uint64(0), errors.New("Not supported method:" + methodad-gome)
}
